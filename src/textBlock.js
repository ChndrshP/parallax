    ...
    return(
        <div id="textblock">
            <div id="textblock-container">
                <h1 id="textblock-title">Adventurer</h1>
                <p id="textblock-content">
                    The year is <strong><i>2067</i></strong>. <br/><br/>
            ...
            <footer id='textblock-footer'>Demo Created With 🧡 By&nbsp;<a id="textblock-Chndrsh" href="https://github.com/ChndrshP">Chndrsh</a></footer>
        </div>
    );
}
